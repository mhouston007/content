...
def get_company_details(client: Client, **args) -> CommandResults:
    ...
    results = CommandResults(
        ...
        readable_output=tableToMarkdown('Account Usage', records)
    )
...
def get_domain_details(client: Client, **args) -> CommandResults:
    ...
    results = CommandResults(
        outputs_prefix="SecurityTrails",
        outputs_key_field=f"SecurityTrails.{domain}.domain_details",
...
def get_domain_subdomains(client: Client, **args) -> CommandResults:
    ...
    results = CommandResults(
        outputs_prefix="SecurityTrails",
        outputs_key_field=f"SecurityTrails.{domain}.subdomains",
        outputs={domain:{'subdomains': response}},
        readable_output=tableToMarkdown(f'Subdomains for {domain}', response)
    )
...
def get_domain_tags(client: Client, **args) -> CommandResults:
    ...
    results = CommandResults(
        outputs_prefix="SecurityTrails",
        outputs_key_field=f"SecurityTrails.{domain}.tags",
        outputs={domain:{'tags': response}},
        readable_output=tableToMarkdown(f'Tags for {domain}', response)
    )
...
def get_domain_whois(client: Client, **args) -> CommandResults:
    ...
    results = CommandResults(
        outputs_prefix="SecurityTrails",
        outputs_key_field=f"SecurityTrails.{domain}.whois",
...
def get_domain_associated_domains(client: Client, **args) -> CommandResults:
    ...
    results = CommandResults(
        outputs_prefix="SecurityTrails",
        outputs_key_field=f"SecurityTrails.{domain}.associated_domains",
